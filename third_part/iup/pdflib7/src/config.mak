...
#     pdcore/pc_config.h - added default PDF_PLATFORM  
#     pdflib/p_intern.h - removed support for other image formats, leave this to IM */
...
SRC := pdflib/pdflib.c $(SRCPDFLIB) $(SRCPDCORE) $(SRCFONT)
