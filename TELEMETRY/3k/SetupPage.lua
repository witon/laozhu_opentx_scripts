...
local function run(event, time)
    ...
    lcd.drawText(0, 20, "Round Reset Switch", SMLSIZE + LEFT)
    IVdraw(roundResetSwitchSelector, 128, 20, invers, SMLSIZE + RIGHT)
    lcd.drawText(0, 30, "Var Slider", SMLSIZE + LEFT)
    IVdraw(varSliderSelector, 128, 30, invers, SMLSIZE + RIGHT)
    lcd.drawText(0, 40, "Read Switch", SMLSIZE + LEFT)
    IVdraw(readSwitchSelector, 128, 40, invers, SMLSIZE + RIGHT)
