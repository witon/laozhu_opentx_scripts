...
local function testLoadAndUnload()
    ...
    LZ_runModule(gScriptDir .. "TELEMETRY/common/TextEditO.lua")
    ...
    LZ_runModule(gScriptDir .. "TELEMETRY/common/OutputSelectorO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/common/CurveSelector.lua")
    CSunload()
	LZ_runModule(gScriptDir .. "TELEMETRY/common/ModeSelectorO.lua")
...
local function initUI()
    ...
    LZ_runModule(gScriptDir .. "TELEMETRY/common/NumEditO.lua")
    LZ_runModule(gScriptDir .. "TELEMETRY/common/OutputSelectorO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/common/CurveSelectorO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/common/ModeSelectorO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/common/ViewMatrixO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/3k/TaskSelectorO.lua")
	LZ_runModule(gScriptDir .. "TELEMETRY/common/TimeEditO.lua")
