...
dofile(HOME_DIR .. "test/TestTimerO.lua")
...
dofile(HOME_DIR .. "test/TestCompetitionBroadcast/TestTaskFileParser.lua")
dofile(HOME_DIR .. "test/TestCompetitionBroadcast/TestGroupFileParser.lua")
